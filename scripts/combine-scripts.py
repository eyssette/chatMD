...
with open(chatbot_js_file, "r") as chatbot_file, open(chatdata_js_file, "r") as chatdata_file, open(custom_js_file, "r") as custom_file, open(utils_js_file, "r") as utils_file, open(typewriter_js_file, "r") as typewriter_file, open(markdown_js_file, "r") as markdown_file, open(nlp_js_file, "r") as nlp_file:
...
combined_content = custom_content + utils_content + markdown_content + nlp_content + typewriter_content + chatbot_content + chatdata_content
