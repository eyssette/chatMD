...
config.yaml.useLLM = {...config.yaml.useLLM, ...RAG};// Pour tirer au hasard un élément dans un tableau
...
}).call(undefined);// Extensions pour Showdown
...
function getRAGcontent(informations) {
	if(informations) {
...
async function createChatBot(chatData) {
